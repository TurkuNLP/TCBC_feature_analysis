...
train_ds = train_ds.map(mapConlluData2RawText, batched=True, batch_size=16, load_from_cache_file=False)
#Evaluation dataset
...
eval_ds = eval_ds.map(mapConlluData2RawText, batched=True, batch_size=16, load_from_cache_file=False)
#Test dataset
...
test_ds = test_ds.map(mapConlluData2RawText, batched=True, batch_size=16, load_from_cache_file=False)
...
trainer.save_model("FinBERT_for_book_snippets_5_new")
